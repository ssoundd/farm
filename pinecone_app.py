...
import uuid
from pinecone_main import load_vector_store, create_chain, get_answer
...
if user_input := st.chat_input("궁금하신 질문을 입력하세요."):
    ...
    response = get_answer(st.session_state.farm_vs, user_input, st.session_state.chain, history)
